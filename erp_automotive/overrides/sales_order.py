...
class CustomSalesOrder(SalesOrder):
    def on_submit(self):
        items_details = self.get("items")
        from_voucher_type = None  # or set it to "Pick List" or "Purchase Receipt" if needed
        notify = True
    ...
    def create_stock_reservation_entries(
        ...
        validate_stock_reservation_settings(SalesOrder)
        ...
        if items_details:
            for item in items_details:
                so_item = frappe.get_doc("Sales Order Item", item.get("self_item"))
